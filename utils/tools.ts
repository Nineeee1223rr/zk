...
export function getSystemPrompt() {
    const content = JSON.parse(localStorage.getItem('settings') || '{}').system_prompt || 'You are a large language model. Please respond to me in Chinese according to my instructions.'
